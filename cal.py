    ...
    def results(self):
        if not self.isEqual: 
            ...
            if (self.label_result.text() == "777"):
                img2 = Image.open(r'C:\Users\79629\Desktop\Проект\777.jpg')
                img2.show()
               
            if (self.label_result.text() == "9"):
                img3 = Image.open(r'C:\Users\79629\Desktop\Проект\9.png')
                img3.show()                
                       
            if (self.label_result.text() == "73"):
                img4 = Image.open(r'C:\Users\79629\Desktop\Проект\73.jpg')
                img4.show()                
                
            if (self.label_result.text() == "23"):
                img5 = Image.open(r'C:\Users\79629\Desktop\Проект\23_23.jpg')
                img5.show()                 
 
            if (self.label_result.text() == "6174"):
                img6 = Image.open(r'C:\Users\79629\Desktop\Проект\6174.jpg')
                img6.show()                
                
            if (self.label_result.text() == "11"):
                img7 = Image.open(r'C:\Users\79629\Desktop\Проект\11.jpg')
                img6.show()                
